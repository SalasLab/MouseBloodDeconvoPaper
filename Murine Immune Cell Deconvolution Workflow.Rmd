---
title: "Official Murine Immune Deconvolution Script"
author: "Lucas A Salas, Samuel R Reynolds"
...
load("~/Desktop/Christensen Lab/Mouse Methylation/betas_noob_collapsed.RData")

# Loading minfi-preprocessed beta values for Zhou et al.'s monocyte samples.
load("~/Desktop/Christensen Lab/Mouse Methylation/betaszhou_noob_collapsed.RData")

# Loading the phenotype data for Zhou et al.'s monocyte samples.
load("~/Desktop/Christensen Lab/Mouse Methylation/annotzhoublood.RData")
```
...
save(candObjectAll, file = "~/Desktop/Christensen Lab/Mouse Methylation/candObjectAll.RData")
```
...
load("~/Desktop/Christensen Lab/Mouse Methylation/diffAllSamples.RData")
...
save(trainingCovariates, file = "~/Desktop/Christensen Lab/Mouse Methylation/trainingCovariates.RData")
save(trainingBetas, file = "~/Desktop/Christensen Lab/Mouse Methylation/trainingBetas.RData")
```
...
#400 "The Average RMSE = 9.793 and R2 = 0.744 for the IDOL Optimized Library"☺
...
allBetas_DMCs$B <- rowMeans(allBetas_DMCs[, allPheno[allPheno$CellType == "B", ID]])
allBetas_DMCs$CD4 <- rowMeans(allBetas_DMCs[, allPheno[allPheno$CellType == "CD4", ID]])
allBetas_DMCs$CD8 <- rowMeans(allBetas_DMCs[, allPheno[allPheno$CellType == "CD8", ID]])
allBetas_DMCs$Mono <- rowMeans(allBetas_DMCs[, allPheno[allPheno$CellType == "Monocyte", ID]])
allBetas_DMCs$NK <- rowMeans(allBetas_DMCs[, allPheno[allPheno$CellType == "NK", ID]])
allBetas_DMCs$PMN <- rowMeans(allBetas_DMCs[, allPheno[allPheno$CellType == "PMN", ID]])
